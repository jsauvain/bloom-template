...
//
// useServerDocumentContext + {headNodes} is the SDK-55 contract: the layout
// stack (react-native-screens, status bar, etc.) injects required attrs/nodes
// through that hook. Spread/render them or web SSR breaks.
